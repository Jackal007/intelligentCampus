...
class Below2_5_RankCalculater(XXCalculater.XXCalculater):
    def setLevel(self):
        ...
        A = Below2_5_Rank[int(len(Below2_5_Rank) * 0.25)][0]
        B = Below2_5_Rank[int(len(Below2_5_Rank) * 0.5)][0]
        C = Below2_5_Rank[int(len(Below2_5_Rank) * 0.75)][0]
        D = Below2_5_Rank[len(Below2_5_Rank)- 1][0]
        self.level = [A, B, C, D]
