...
class CostTimesDayLaundryRoomCalculater(XXCalculater.XXCalculater):
    def setLevel(self):
        sql = "select cost_times_day_laundryroom from students order by cost_times_day_laundryroom"
