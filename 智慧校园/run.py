...
CostDinnerHallAverageCalculater = CostDinnerHallAverageCalculater.CostDinnerHallAverageCalculater(MyConfig.AverageCost_level)
CostSuperMarketAverageCalculater = CostSuperMarketAverageCalculater.CostSuperMarketAverageCalculater(MyConfig.AverageCost_level)
